...
public class Teste1 {
	public static void main(String[] args) {
		...
		System.out.println(col.addFigura(c2)); //t
		System.out.println(col.addFigura(r1)); //t
		System.out.println(col.addFigura(r1)); //f
		System.out.println(col.addFigura(r2)); //t
		System.out.println(col.addFigura(c1)); //t
		System.out.println(col.addFigura(q2)); //t
		System.out.println(col.addFigura(q1)); //f
		System.out.println(col.delFigura(r1)); //t
		System.out.println(col.addFigura(q1)); //t
