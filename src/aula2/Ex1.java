...
public class Ex1 {
	...
	public static void addUser(ListClient cl) {
		...
		if (op.equalsIgnoreCase("e")) {
			...
			Cliente e = new Cliente(Nmecc, Curso, ns++, Datadeins, Nome, NumCC, Born);
			cl.addClient(e);
		}
		else {
			...
			ns = ns++;
			Cliente f = new Cliente(Nfunc, NIF, ns, Datadeins, Nome, NumCC, Born);
			cl.addClient(f);
		}
	}
	...
	public static void ini(ListClient lc, ListVideo lv, Loans ld) {
        ...
        idv++;
        lc.addClient(new Cliente(888888, "NTC", ns, new Data(), "Jorge Paiva", 1898999,new Data(13,11,1995)));
        ns++;
        lc.addClient(new Cliente(940303, "EET", ns, new Data(), "Carla Esteves", 1600232,new Data(01,12,2001)));
        ns++;
        lc.addClient(new Cliente(111111, 122221, ns,new Data() , "Amy Esteves", 1700732,new Data(01,12,1965)));
        ns++;
	}
}
